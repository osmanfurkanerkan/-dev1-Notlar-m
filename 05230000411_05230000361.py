...
while other_patients:
    ...
    if ((severity_of_hemophilia=="severe") or (severity_of_hemophilia=="moderate" and bleeding_episodes>=36 )) and amount_of_BU<5:
    ...
    if prophylaxis_will_be_applied=="Apply":
        ...
        print(f"how many IU will be applied = {(bottle_count_2000*bottle_capacity_2000)+(bottle_count_1500*bottle_capacity_1500)+(bottle_count_1000*bottle_capacity_1000)+(bottle_count_500*bottle_capacity_500)+(bottle_count_250*bottle_capacity_250)}")
